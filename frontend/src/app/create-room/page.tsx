...
const CreateJoinRoom = () => {
  ...
  return (
    <div className="min-h-screen text-white flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_500px_at_50%_30%,#38461b,transparent)] pointer-events-none"></div>
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="bg-gradient-to-t from-gray-300 via-[#b1ff14ea] to-[#b2ff14] bg-clip-text text-transparent">
        ...
        {/* Main content card */}
        <div className="backdrop-blur-xl bg-black/40 rounded-2xl border border-[#b2ff14]/30 overflow-hidden shadow-lg shadow-[#b2ff14]/5 py-24">
          {/* Create Room Tab */}
          {activeTab === "create" && (
            <motion.div
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    {showDropdown && (
  <div className="absolute z-10 mt-1 w-full bg-black/90 backdrop-blur-xl border border-[#b2ff14]/30 rounded-lg shadow-lg shadow-black/50 overflow-y-auto max-h-60">
